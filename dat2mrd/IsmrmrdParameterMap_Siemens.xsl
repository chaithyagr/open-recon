    ...
    <xsl:template match="/">
            ...
            <encoding>
                ...
                <encodedSpace>
                    <matrixSize>
                        ...
                        <y>
							<xsl:value-of select="siemens/IRIS/DERIVED/N0FPEFTLength"/>
                        </y>
                ...
                <reconSpace>
                    <matrixSize>
                        <x>
                            <xsl:value-of select="siemens/IRIS/DERIVED/N0FImageColumns"/>
                        </x>
                        <y>
                            <xsl:value-of select="siemens/IRIS/DERIVED/N0FImageLines"/>
                        </y>
                        <xsl:choose>
                    ...
                    <fieldOfView_mm>
						...
						<xsl:for-each select="siemens/IRIS/DERIVED/N0FPhaseFoV">
						...
						<xsl:for-each select="siemens/IRIS/DERIVED/N0FThickness">
							<xsl:if test="position() = 1">
									<z>
										<xsl:value-of select="." />
									</z>
        ...
        <parallelImaging>
          ...
          <calibrationMode>
              ...
              <xsl:when test="siemens/MEAS/sPat/ucRefScanMode = 256">separate</xsl:when>
              <xsl:when test="siemens/MEAS/sPat/ucRefScanMode = 512">separate</xsl:when>
              <xsl:when test="siemens/MEAS/sPat/ucRefScanMode = 1024">separate</xsl:when>
          ...
          <xsl:if test="(siemens/MEAS/sPat/ucRefScanMode = 1) or (siemens/MEAS/sPat/ucRefScanMode = 16) or (siemens/MEAS/sPat/ucRefScanMode = 32) or (siemens/MEAS/sPat/ucRefScanMode = 64)">
            ...
            <userParameters>
                ...
                <xsl:if test="siemens/MEAS/sWipMemBlock/alFree[5]">
                    <userParameterLong>
                        <name>OversamplingFactor</name>
                        <value><xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[5]"/></value>
                    </userParameterLong>
                </xsl:if>
                    
                <xsl:if test="siemens/MEAS/sWipMemBlock/alFree[51]">
                    <userParameterLong>
                        <name>NumberOfReadoutSamples</name>
                        <value><xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[51]"/></value>
                    </userParameterLong>
                </xsl:if>
                    
                <xsl:if test="siemens/MEAS/sWipMemBlock/alFree[14]">
                    <userParameterLong>
                        <name>SendTrajectory</name>
                        <!-- 1 means trajectory not sent
                             2 means trajectory sent prior measurement
                             3 means trajectory sent during measurement
                        -->
                        <value><xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[14]"/></value>
                    </userParameterLong>
                </xsl:if>
                ...
                <xsl:if test="siemens/MEAS/sFastImaging/lTurboFactor">
                    <userParameterLong>
                        ...
                        <value><xsl:value-of select="siemens/MEAS/sFastImaging/lTurboFactor"/></value>
                    </userParameterLong>
                </xsl:if>
                ...
                <xsl:if test="siemens/MEAS/sWipMemBlock/adFree[7]">
                    <userParameterDouble>
                        <name>ShiftInReadout</name>
                        <value><xsl:value-of select="siemens/MEAS/sWipMemBlock/adFree[7]"/></value>
                    </userParameterDouble>
                </xsl:if>
                    
                <xsl:if test="siemens/MEAS/sWipMemBlock/adFree[8]">
                    <userParameterDouble>
                        <name>ShiftInPhase</name>
                        <value><xsl:value-of select="siemens/MEAS/sWipMemBlock/adFree[8]"/></value>
                    </userParameterDouble>
                </xsl:if>
                    
                <xsl:if test="siemens/MEAS/sWipMemBlock/adFree[9]">
                    <userParameterDouble>
                        <name>ShiftInSlice</name>
                        <value><xsl:value-of select="siemens/MEAS/sWipMemBlock/adFree[9]"/></value>
                    </userParameterDouble>
                </xsl:if>

                <xsl:if test="siemens/MEAS/sWipMemBlock/adFree[10]">
                    <!-- MaxGradAmplitude is necessary for older version of gradient trajectories (version<4.0) when sent through waveform -->
                    <userParameterDouble>
                        <name>MaxGradAmplitude</name>
                        <value><xsl:value-of select="siemens/MEAS/sWipMemBlock/adFree[10]"/></value>
                    </userParameterDouble>
                </xsl:if>
                    
                <xsl:if test="siemens/MEAS/sWipMemBlock/tFree">
                    <userParameterString>
                        <name>GradientFilename</name>
                        <value><xsl:value-of select="siemens/MEAS/sWipMemBlock/tFree"/></value>
                    </userParameterString>
                </xsl:if>
